...
.nav-wrap{width:100%;max-width:1150px;margin:0 auto;padding:18px 14px 10px}
.nav{display:grid;grid-template-columns:1fr;gap:16px}
.nav a.btn{width:100%;min-height:145px;border-radius:24px;padding:24px 26px;display:flex;align-items:center;gap:22px;text-align:left;box-shadow:0 4px 18px #00000018}
.nav-icon{font-size:58px;line-height:1;width:76px;text-align:center;flex:0 0 76px}
